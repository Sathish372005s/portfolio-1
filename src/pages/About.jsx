  ...
  return (
    <div className="py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Profile Summary */}
        <div className="mb-16 bg-neutral-900 border border-neutral-800 p-8 md:p-10 rounded-2xl text-center md:text-left flex flex-col md:flex-row items-center md:items-start justify-between gap-8" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Education */}
          <div className="bg-neutral-900 border border-neutral-800 p-8 rounded-xl h-full" data-aos="fade-right" data-aos-delay="200">
          ...
          <div className="bg-neutral-900 border border-neutral-800 p-8 rounded-xl h-full" data-aos="fade-left" data-aos-delay="200">
            <div className="flex items-center mb-6">
