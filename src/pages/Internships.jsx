        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {RESUME_DATA.experience.map((exp, index) => (
              <div key={index} className="bg-neutral-900 border border-neutral-800 p-8 rounded-lg relative">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {Object.entries(RESUME_DATA.skills).map(([category, skills]) => (
                <div key={category} className="bg-neutral-900 border border-neutral-800 p-6 rounded-lg">
